...
infile = open('disp_sine_table.txt') # From Table 1 in Kieffer, 1979c
array = []
...
for i in WE_array:
    ...
    **2*math.exp(i*CONV/ITEMP))/((math.exp(i*CONV/ITEMP)-1)**2))
...
print('The heat capacity for zircon at ', ITEMP, ' K is:', format(Cv, '.2f'), ' J/mol.K')
